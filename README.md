# Shah Mir Aizaz - Finance Portfolio
...
Open the repository on GitHub, click `index.html`, click the pencil icon to edit (or re-upload a new version), and commit. Changes go live within a minute or two.

## Attaching a custom domain later (optional)
...
- The site is fully self-contained: no frameworks, no build step, no external fonts or scripts.
- Dark mode follows the visitor's system preference and can be toggled from the top bar.
- All client-confidential figures in the copy were sanitized; structural stats (sheet counts, formula counts, horizons) are exact.
